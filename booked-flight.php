...
<body>
    ...
    <div class="container mt-5">
        <h2 style="text-align: center;">Список бронирований</h2>
        ...
        <table class="table table-striped">
            ...
            <?php
                ...
                // Отображение бронирований в таблице с объединенными данными
                ...
                if ($resultBookings->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='8' class='text-center'><h3>Нет доступных бронирований</h3></td></tr>";
                }
                ?>
            </tbody>
        </table>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-danger" name="confirm_delete_booking">Удалить</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        // Нажатие обработчика события для кнопок удаления
